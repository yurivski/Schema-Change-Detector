...
||||||
|-|-|-|-|-|
|**DESCRIÇÃO**|**LINK**|-|**DESCRIÇÃO**|**LINK**|
|**Criar contrato inicial**|[Clique Aqui](#exemplo-de-uso-inicial)|-|**Fluxo após migration**|[Clique Aqui](#fluxo-típico-após-uma-migration)|
|**Importar como biblioteca**|[Clique Aqui](#biblioteca-python)|-|**Conexão direta pelo `.env`**|[Clique Aqui](#uso-sem---db-url-via-env)|
|**Classe SchemaGuard**|[Clique Aqui](#construção-manual-com-schemaguard)|-|**Classificação dos drifts**|[Clique Aqui](#classificação-dos-drifts)|
|**Classe SchemaComparator**|[Clique Aqui](#usando-schemacomparator-diretamente)|-|**Stack**|[Clique Aqui](#stack)|
|**Fluxo de trabalho**|[Clique Aqui](#funcionamento)|-|**Licensa**|[Clique Aqui](#licença)|
|**Nível de confiança**|[Clique Aqui](#confiança-do-possible_rename)|-|**Autor**|[Clique Aqui](#autor)|
